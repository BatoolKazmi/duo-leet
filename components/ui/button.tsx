...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50 uppercase traching-wide",
  {
    variants: {
      variant: {
        default:
        ...
        ghost:
          "bg-transparent test-slatre-500 border-transparent border-0 hover:bg-slate-100",
        sidebar:
